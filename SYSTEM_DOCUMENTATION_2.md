# Benchmark LLM - System Documentation

**Document Version:** 1.0  
**Last Updated:** 2026-03-14  
**Database Schema Version:** 3 (Model Variants System)
...
| Remover modelos | Sim | Parcial | Não | Não |
| Mudar seed | Não | Não | Não | Não |
| Mudar dataset/questions | Não | Não | Não | Não |
| Re-executar run (`--run-id`) | Sim | Parcial | Parcial | Sim |
...
| Reutilizar com config diferente | Parcial | Protocolo sobrescrito (com warning) |
