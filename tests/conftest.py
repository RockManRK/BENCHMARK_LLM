...
# Import TO-BE components (src_v2 namespace)
# Note: These will be implemented in Phase 5+
# For now, we define the minimal schema needed for tests


MINIMAL_SCHEMA_SQL = """
-- Minimal schema for Phase 4-5 tests
-- Full schema will be added in Phase 6
...
def in_memory_db() -> Generator[sqlite3.Connection, None, None]:
    ...
    The database is initialized with the minimal TO-BE schema containing:
    - experiments
    - model_variants
    - question_snapshots
    - runs
