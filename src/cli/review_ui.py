        ...
        try:
            ...
            cursor.execute(
                ...
                SELECT r.response_id, r.run_id, r.snapshot_id, r.question_id, r.model_id,
                       ...
                       r.input_tokens, r.output_tokens, r.total_tokens, r.reasoning_tokens,
                       r.cost, r.raw_response_json, r.timestamp,
                       r.parse_confidence, r.review_status, r.reviewed_by, r.reviewed_at, r.manual_answer,
                       q.stem, q.options_json, q.answer_key
                FROM responses r
