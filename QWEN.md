...
**Keeping system documentation up-to-date is a high-priority task.**

Whenever you make a change to the code:
- Assess whether the documentation needs to be updated.
- Ensure that all affected documents are updated correctly.
- Follow the existing documentation standard.
